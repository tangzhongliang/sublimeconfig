...
public class Capability extends CapabilityElement {
	...
	private static final String KET_PRINT_PAPER_SZIE_LIST			= "paperSizeList";
     ...
     * paperSizeList (Array[String])
     */
    public List<String> getPrintPaperSizeList() {
        return getArrayValue(KET_PRINT_PAPER_SZIE_LIST);
    }
